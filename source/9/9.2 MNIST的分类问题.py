# 贡献者：{沙舟}
# 源代码出处：https://github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/examples/tutorials/mnist/mnist_softmax.py
# 数据集下载地址：http://yann.lecun.com/exdb/mnist/ (同时可查看数据格式)


#导入input_data.py文件，使用tensorflow.contrib.learn中的read-data_sets加载数据
